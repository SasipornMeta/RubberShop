...
public class ShowReportCustomerCube extends BaseAdapter {

    private Context context;
    private String[] dateTimeStrings, totalStrings, weightStrings, percentStrings, priceStrings;

    public ShowReportCustomerCube (Context context,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.listview_report_customer_cube, parent, false);
