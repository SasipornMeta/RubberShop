...
public class ShowReportCustomerSheet extends BaseAdapter {

    private Context context;
    private String[] dateTimeStrings, totalStrings, weightStrings, priceStrings;

    public ShowReportCustomerSheet (Context context,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.listview_report_customer_sheet, parent, false);
